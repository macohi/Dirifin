...
- **ADDED SURVIVAL MODE**
	- Accessible through the main menu it has you play a random level for AS LONG AS POSSIBLE.
...
- Added "Loading Screen" that appears before going to the main menu where the player is spinning
